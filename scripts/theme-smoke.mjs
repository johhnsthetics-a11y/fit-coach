...
const checks = [
  ...
  ['Build marker was bumped for workouts audit', app.includes("COACH_FIT_PRO_BUILD_MARKER = 'treinos-light-polish-20260909'")],
  ['Service worker cache was bumped', sw.includes('coach-fit-pro-pwa-20260909-treinos-light-polish-v1')],
  ['Public version file was bumped', version.includes('treinos-light-polish-v1-20260909')],
