...
const checks = [
  ...
  ['Build marker was bumped for workouts audit', app.includes("COACH_FIT_PRO_BUILD_MARKER = 'nutricao-dietas-prescritas-responsive-20260909'")],
  ['Service worker cache was bumped', sw.includes('coach-fit-pro-pwa-20260909-nutricao-dietas-prescritas-v1')],
  ['Public version file was bumped', version.includes('nutricao-dietas-prescritas-responsive-v1-20260909')],
