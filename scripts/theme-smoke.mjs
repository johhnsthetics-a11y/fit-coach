...
const checks = [
  ...
  ['Build marker was bumped for workouts audit', app.includes("COACH_FIT_PRO_BUILD_MARKER = 'nutricao-tabs-layout-responsive-20260909'")],
  ['Service worker cache was bumped', sw.includes('coach-fit-pro-pwa-20260909-nutricao-tabs-layout-v1')],
  ['Public version file was bumped', version.includes('nutricao-tabs-layout-responsive-v1-20260909')],
