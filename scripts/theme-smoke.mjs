...
const checks = [
  ...
  ['Build marker was bumped for workouts audit', app.includes("COACH_FIT_PRO_BUILD_MARKER = 'treinos-legacy-visual-fix-20260909'")],
  ['Service worker cache was bumped', sw.includes('coach-fit-pro-pwa-20260909-treinos-legacy-visual-fix-v1')],
  ['Public version file was bumped', version.includes('treinos-legacy-visual-fix-v1-20260909')],
