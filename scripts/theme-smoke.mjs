...
const checks = [
  ...
  ['Build marker was bumped for workouts audit', app.includes("COACH_FIT_PRO_BUILD_MARKER = 'treinos-open-no-warning-fix-20260909'")],
  ['Service worker cache was bumped', sw.includes('coach-fit-pro-pwa-20260909-treinos-open-no-warning-fix-v1')],
  ['Public version file was bumped', version.includes('treinos-open-no-warning-fix-v1-20260909')],
...
['Notification overlay supports close controls', app.includes('handleNotificationKeyDown') && app.includes('coach-notification-popover-backdrop') && app.includes('Fechar notificações')],
  ...
  ['Error recovery clears stale app cache and service worker', app.includes('function clearAppRuntimeCacheAndReload') && app.includes('coachfitpro-last-view-error') && app.includes('window.caches.delete') && sw.includes('treinos-open-no-warning-fix-v1')],
