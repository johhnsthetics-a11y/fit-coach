...
const checks = [
  ...
  ['Service worker cache identifies the current release', sw.includes('coach-fit-pro-pwa-20260919-readiness-v1')],
  ['Public and application versions identify the current release', version.trim() === 'webapp-readiness-20260919' && app.includes(`COACH_FIT_PRO_BUILD_MARKER = '${version.trim()}'`)],
