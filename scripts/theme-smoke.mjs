...
const checks = [
  ...
  ['Service worker cache identifies the current release', sw.includes('coach-fit-pro-pwa-20260925-workout-v1')],
  ['Public and application versions identify the current release', version.trim() === 'webapp-workout-20260925' && app.includes(`COACH_FIT_PRO_BUILD_MARKER = '${version.trim()}'`)],
